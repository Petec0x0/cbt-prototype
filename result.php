...
<div class="container" style="padding: 5% 0%; margin: 0 auto;">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <center><h4>Your total score is  <?php echo $score; ?></h4></center>
      <br>
      <p><i class="fa fa-check"></i> <span class="answer"><?php echo $right_answer;?></span> Correct Answer</p>
      <p><i class="fa fa-times"></i> <span class="answer"><?php echo $wrong_answer;?></span> Wrong Answer</p>
      <p><i class="fa fa-ban"></i> <span class="answer"><?php echo $unanswered;?></span> Empty</p>
      <br>
