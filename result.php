...
mysqli_query($link, "INSERT INTO tb_result (username, answer_right, answer_wrong, answer_empty, score, exam_id) VALUES ('$username','$right_answer','$wrong_answer','$unanswered','$score', '$exam_id')") or die(mysqli_error($link));
  ...
  <div class="container" style="padding: 5% 0%; margin: 0 auto;">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <br>
        <p><i class="fa fa-check"></i> <span class="answer">
            <?php echo $right_answer; ?>
          </span> Correct Answer</p>
        <p><i class="fa fa-times"></i> <span class="answer">
            <?php echo $wrong_answer; ?>
          </span> Wrong Answer</p>
        <p><i class="fa fa-ban"></i> <span class="answer">
            <?php echo $unanswered; ?>
          </span> Empty</p>
        <br>
