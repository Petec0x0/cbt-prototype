...
<div class="container" style="padding: 7% 0%;min-width: 30%; max-width: 80%;margin: 0 auto;">
 ...
 <div class="card">
 <div class="card-header bg-primary text-white" align="center"><strong><h4>List</h4></strong></div>
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      <div class="input-group mb-3"><div class="input-group-prepend">
        ...
        <input type="text" class="form-control <?php echo (!empty($nama_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $nama; ?>" name = "nama" placeholder="Full name" style="" />
      </div>
    ...
    <div class="form-group">
      <div class="input-group mb-3"><div class="input-group-prepend">
        ...
        <select class="custom-select <?php echo (!empty($team_err)) ? 'is-invalid' : ''; ?>" name="team">
                  <option value="0" style="display:none">Level</option>
    ...
    <!-- <div class="form-group">
      <div class="input-group mb-3"><div class="input-group-prepend">
        ...
        <input type="number" class="form-control <?php echo (!empty($team_err)) ? 'is-invalid' : ''; ?>" name = "team" placeholder="Exam Group" />
      </div>
      <span class="help-block" style="color: red;"><?php echo $team_err; ?></span>
    </div> -->
    ...
    <center>Please <a href="login.php">click here</a> to login</center>
  	</form>
  </div>
