        ...
        <form id="login" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          <div class="form-group">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>"
                value="<?php echo $username; ?>" name="username" placeholder="Username" style="" />
            </div>
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control <?php echo (!empty($nama_err)) ? 'is-invalid' : ''; ?>"
                value="<?php echo $nama; ?>" name="nama" placeholder="Full name" style="" />
            </div>
            <span class="help-block" style="color: red;">
              <?php echo $nama_err; ?>
            </span>
