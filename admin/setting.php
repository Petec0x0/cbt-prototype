...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(!is_numeric($_POST['totalQuestion']) && !intval($_POST['totalQuestion'])){
        $totalQuestion_err = "Please fill in the number of questions.";     
    ...
    if(!is_numeric($_POST['pointRight']) && !intval($_POST['pointRight'])){
        $pointRight_err = "Please fill in the value of the correct answer.";     
    } else{
        $pointRight = $_POST['pointRight'];
    }

    if(!is_numeric($_POST['pointWrong']) && !intval($_POST['pointWrong'])){
        $pointWrong_err = "Please fill in the value of the wrong answer.";     
    } else{
        $pointWrong = $_POST['pointWrong'];
    }

    if(!is_numeric($_POST['pointUnanswered']) && !intval($_POST['pointUnanswered'])){
        $pointUnanswered_err = "Please fill in the blank answer value.";     
    } else{
...
@media (max-width: 992px) {
  ...
  <body style="font-family: 'Roboto', sans-serif">
    ...
    <div class="wrapping">
	    ...
	    <div class="container">
          <center><h2>Arrangement</h2></center>
          <br>
          <?php if(isset($_GET['msg'])){
            if ($_GET['msg'] === "success"){
              echo "<div class='alert alert-success' role='alert'>Arrangement saved successfully!</div>";
            }
            else{
              echo "<div class='alert alert-danger' role='alert'>Arrangement failed to save!</div>";
            }
          } ?>
    ...
    <div class="form-group">
      <label for="pointRight">Correct Answer Points</label>
    ...
    <div class="form-group">
      <label for="pointWrong">Wrong Answer Points</label>
    ...
    <div class="form-group">
      <label for="pointUnanswered">Blank Answer Points</label>
