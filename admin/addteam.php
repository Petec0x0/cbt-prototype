...
@media (max-width: 992px) {
  ...
  <body style="font-family: 'Roboto', sans-serif">
    ...
    <div class="wrapping">
        ...
        <div class="container">
	     <center><h2>User Exam Group</h2></center><br>
    ...
    <div class="form-group">
      <label for="nameteam">Add Exam Group New</label>
      <div class="input-group mb-3"><div class="input-group-prepend">
        <span class="input-group-text"><i class="fa fa-handshake-o"></i></span>
        </div>
        <input type="text" class="form-control <?php echo (!empty($nameteam_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $nameteam; ?>" name = "nameteam" placeholder="Name Exam Group" style="" />
      </div>
      ...
      <input type="submit" class="btn btn-outline-primary" value="Add">
          ...
          <tbody>
                  ...
                  while ( $view = mysqli_fetch_assoc($query) ) {
                    ...
                    echo "<td> <a href=\"editteam.php?id=$view[id_team]\">Change</a> </td>";
                    echo "<td> <a href=\"deleteteam.php?id=$view[id_team]\" onClick=\"return confirm('Anda yakin ingin menghapus?')\">Delete</a> </td>";
                    echo "</tr>";
                  }
                  ?>
          </tbody>
