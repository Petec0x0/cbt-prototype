	    ...
	    <table id="viewResult" class="table display" style="width:100%">
          ...
          <tbody>
                  ...
                  while ( $view = mysqli_fetch_assoc($query) ) {
                    ...
                    echo "<td> <a href=\"edituser.php?id=$view[username]\">Change</a> </td>";
                    echo "<td> <a href=\"deleteuser.php?id=$view[username]\" onClick=\"return confirm('Anda yakin ingin menghapus?')\">Delete</a> </td>";
                    echo "</tr>";
                  }
                  ?>
          </tbody>
