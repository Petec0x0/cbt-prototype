...
@media (max-width: 992px) {
  ...
  <body style="font-family: 'Roboto', sans-serif">
    ...
    <div class="wrapping">
        ...
        <div class="container">
          <center><h2>Change User</h2></center>
          <br>
    ...
    <div class="form-group">
      <div class="input-group mb-3"><div class="input-group-prepend">
        ...
        <input type="text" class="form-control <?php echo (!empty($nama_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $value['nama']; ?>" name = "nama" placeholder="Full Name" style="" />
      </div>
