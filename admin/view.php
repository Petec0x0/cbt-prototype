...
$query = mysqli_query( $link, "select tb_user.nama, tb_user.username, tb_user.team, tb_result.answer_right, tb_result.answer_wrong, tb_result.answer_empty, tb_result.score, tb_team.name_team from tb_user JOIN tb_result on tb_user.username = tb_result.username JOIN tb_team on tb_user.team=tb_team.id_team;");
