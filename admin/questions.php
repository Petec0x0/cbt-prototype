...
$query = mysqli_query( $link, "select id_question, question_name, question_image, option1, option2, option3, option4, answer from tb_question where 1;");
  ...
  <script type="text/javascript">
    ...
    <div class="wrapping">
	    ...
	    <div class="content-wrapping" style="text-align: justify;">
          ...
          <center><h2>List Question</h2></center>
          ...
          <tbody>
                  ...
                  while ( $view = mysqli_fetch_assoc($query) ) {
                    ...
                    echo "<td>";
                    if($view['question_image'] !== "" && !is_null($view['question_image'])){echo "<img src='../$view[question_image]' style='max-width: 75%'><br>";}
